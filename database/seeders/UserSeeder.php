...
class UserSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $users = [
            ...
            ['tipo' => '3', 'name' => 'base', 'email' => 'base@gmail.com', 'password' => Hash::make('password'), 'paterno' => 'Bátiz', 'materno'=> 'Paredes', 'nombres' => 'Juan de Dios', 'jefe_directo_id' => 1, 'jefe_departamento_id' => 1 ],
